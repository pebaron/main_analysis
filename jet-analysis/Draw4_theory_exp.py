...
##h_ListOfFractionPt900[2].rebinBy(2)
##h_ListOfFractionPt900[0].rebinBy(2)
##h_ListOfFractionPt13000[2].rebinBy(2)
##h_ListOfFractionPt13000[0].rebinBy(2)

h_ListOfFractionPt900[2].rebinBy(50,50,200)
h_ListOfFractionPt900[0].rebinBy(50,50,200)
h_ListOfFractionPt900[2].rebinBy(4,30,50)
h_ListOfFractionPt900[0].rebinBy(4,30,50)
h_ListOfFractionPt900[2].rebinBy(2,20,30)
h_ListOfFractionPt900[0].rebinBy(2,20,30)


h_ListOfFractionPt13000[2].rebinBy(100,100,200)
h_ListOfFractionPt13000[0].rebinBy(100,100,200)
h_ListOfFractionPt13000[2].rebinBy(50,50,100)
h_ListOfFractionPt13000[0].rebinBy(50,50,100)
h_ListOfFractionPt13000[2].rebinBy(4,30,50)
h_ListOfFractionPt13000[0].rebinBy(4,30,50)
h_ListOfFractionPt13000[2].rebinBy(2,20,30)
h_ListOfFractionPt13000[0].rebinBy(2,20,30)

#print("Width: ", h_ListOfFractionPt13000[0].bin(3).xWidth)
#for i in range(1,h_ListOfFractionPt13000[0].numBins):
#    h_ListOfFractionPt13000[0].bin(i).height = h_ListOfFractionPt13000[0].bin(i).height/h_ListOfFractionPt13000[0].bin(i).xWidth
#    h_ListOfFractionPt13000[2].bin(i).height = h_ListOfFractionPt13000[2].bin(i).height/h_ListOfFractionPt13000[2].bin(i).xWidth

def ReturnHisto():
    return mk_numpyhist(h_ListOfFractionPt900[2]/h_ListOfFractionPt900[0]),mk_numpyhist(h_ListOfFractionPt13000[2]/h_ListOfFractionPt13000[0])
    #return mk_numpyhist(h_ListOfFractionPt900[2]),mk_numpyhist(h_ListOfFractionPt13000[2])
