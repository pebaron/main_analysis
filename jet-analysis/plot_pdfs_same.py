...
ax.plot(xs,gluon_xfs,'k', label="gluon")
ax.plot(xs,d_xfs,'r', label="d quark")
ax.plot(xs,u_xfs,'g', label="u quark")
ax.plot(xs,s_xfs,'b', label="s quark")
ax.plot(xs,c_xfs,'c', label="c quark")
ax.plot(xs,b_xfs,'m', label="b quark")
ax.plot(xs,t_xfs,'y', label="t quark")
ax.plot(xs,md_xfs,'r--', label="anti d quark")
ax.plot(xs,mu_xfs,'g--', label="anti u quark")
ax.plot(xs,ms_xfs,'b--', label="anti s quark")
ax.plot(xs,mc_xfs,'c--', label="anti c quark")
ax.plot(xs,mb_xfs,'m--', label="anti b quark")
ax.plot(xs,mt_xfs,'y--', label="anti t quark")

ax.set_title('Plot of x $\cdot$ PDF '+name+' at Q$^2$ = '+str(q2)+' GeV')
ax.set_xlabel('x - momentum fraction')
ax.set_ylabel('x $\cdot$ PDF')
ax.set_xscale("log")
ax.set_ylim(0,2)
